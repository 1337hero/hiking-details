    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">{hikeData.name}</h1>
          <p className="text-xl text-gray-600">{hikeData.location}</p>
          {hikeData.summitElevation && (
            <p className="text-lg text-gray-700 mt-1">Summit: {hikeData.summitElevation}</p>
          )}
        </header>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <dl className="space-y-2">
                <div>
                  ...
                  <dd className="font-medium">{hikeData.bestSeason}</dd>
                </div>
                <div>
                  <dt className="text-sm text-gray-600">Permit Required</dt>
                  <dd className="font-medium">{hikeData.permitRequired ? 'Yes' : 'No'}</dd>
                </div>
                <div>
                  <dt className="text-sm text-gray-600">Dog Friendly</dt>
                  <dd className="font-medium">{hikeData.dogFriendly ? 'Yes' : 'No'}</dd>
                </div>
              </dl>
            </div>
        ...
        {/* Group Coordination */}
        <GroupCoordination groupCoordination={hikeData.groupCoordination} />
